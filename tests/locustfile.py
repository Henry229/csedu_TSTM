...
class QuickstartUser(HttpUser):
    ...
    def rendered01(self):
        ...
        response = self.client.get(f'/api/rendered/{item_id}', name='/api/rendered/item_id',
                                   verify=False, params={"session": self.session, "r_key": get_random_string()},
    ...
    def response01(self):
        ...
        response = self.client.post(f"/api/responses/{item_id}", name='/api/responses/item_id',
                                    verify=False, params={"r_key": get_random_string()},
    ...
    def on_start(self):
        ...
        while try_count < retry_max:
            ...
            response = self.client.get("/inward", name='/inward',
                                       verify=False, params={"token": token_base64, "r_key": get_random_string()})
