    ...
    def __init__(self, *args, **kwargs):
        ...
        self.branch.choices = [(u.id, u.code_name)
                                ...
                                db.session.query(Codebook.id, Codebook.code_name).\
                                   filter(Codebook.code_type == 'test_center').distinct().order_by(Codebook.code_name).all()]
...
class EditProfileAdminForm(FlaskForm):
    ...
    def __init__(self, user, *args, **kwargs):
        ...
        self.branch.choices = [(u.id, u.code_name)
                                for u in
                                db.session.query(Codebook.id, Codebook.code_name).filter(Codebook.code_type == 'test_center').\
